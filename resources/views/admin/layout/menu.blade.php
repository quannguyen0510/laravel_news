    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/loaitin/danhsach">Danh Sach</a>
                    </li>
                    <li>
                        <a href="admin/loaitin/them">Them</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/slide/danhsach">Danh Sach</a>
                    </li>
                    <li>
                        <a href="admin/slide/them">Them</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/user/danhsach">Danh sach</a>
                    </li>
                    <li>
